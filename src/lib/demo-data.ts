...
export const demoUsers = [
  { id: "user_owner", name: "Mike Kowalski", email: "mike@northshoreheating.com", role: "owner" as const, phone: "+13135550101" },
  { id: "user_manager", name: "Sarah Chen", email: "sarah@northshoreheating.com", role: "manager" as const, phone: "+13135550102" },
  { id: "user_csr1", name: "Jen Martinez", email: "jen@northshoreheating.com", role: "csr" as const, phone: "+13135550103" },
  { id: "user_csr2", name: "Dave Thompson", email: "dave@northshoreheating.com", role: "csr" as const, phone: "+13135550104" },
];
...
export const demoTemplates = [
  { id: "tpl_01", name: "Missed Call Auto-Reply", type: "sms" as const, subject: null, body: "Hi {{firstName}}, we missed your call at {{businessName}}! We're sorry we couldn't pick up. How can we help? Reply here or call us back at {{businessPhone}}.", variables: ["firstName", "businessName", "businessPhone"], isArchived: false },
  { id: "tpl_02", name: "Estimate Follow-Up", type: "sms" as const, subject: null, body: "Hi {{firstName}}, just checking in on the {{serviceType}} estimate we sent on {{estimateDate}}. Do you have any questions? We'd love to help get this scheduled for you.", variables: ["firstName", "serviceType", "estimateDate"], isArchived: false },
  { id: "tpl_03", name: "Reactivation Outreach", type: "sms" as const, subject: null, body: "Hi {{firstName}}, it's been a while since your last service with {{businessName}}! We'd love to have you back. Book a tune-up this month and save 15%. Reply YES to schedule.", variables: ["firstName", "businessName"], isArchived: false },
  { id: "tpl_04", name: "Booking Confirmation", type: "sms" as const, subject: null, body: "Hi {{firstName}}, your {{serviceType}} appointment is confirmed for {{appointmentDate}} at {{appointmentTime}}. See you then! - {{businessName}}", variables: ["firstName", "serviceType", "appointmentDate", "appointmentTime", "businessName"], isArchived: false },
  { id: "tpl_05", name: "Estimate Follow-Up Email", type: "email" as const, subject: "Your {{serviceType}} Estimate from {{businessName}}", body: "Hi {{firstName}},\n\nWe wanted to follow up on the estimate we sent for {{serviceType}} on {{estimateDate}}.\n\nYour estimate total: {{estimateAmount}}\n\nIf you have any questions or would like to move forward, just reply to this email or call us at {{businessPhone}}.\n\nBest regards,\n{{businessName}}", variables: ["firstName", "serviceType", "estimateDate", "estimateAmount", "businessPhone", "businessName"], isArchived: false },
  { id: "tpl_06", name: "Maintenance Reminder", type: "email" as const, subject: "Time for Your Annual {{serviceType}} Maintenance", body: "Hi {{firstName}},\n\nIt's been {{monthsSinceService}} months since your last {{serviceType}} service. Regular maintenance helps prevent costly breakdowns and keeps your system running efficiently.\n\nSchedule your maintenance visit today and we'll include a complimentary system inspection.\n\nCall us: {{businessPhone}}\n\n{{businessName}}", variables: ["firstName", "serviceType", "monthsSinceService", "businessPhone", "businessName"], isArchived: false },
];
...
export const demoReportSnapshots = [
